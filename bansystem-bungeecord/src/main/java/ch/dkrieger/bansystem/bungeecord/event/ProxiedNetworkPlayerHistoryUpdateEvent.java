...
public class ProxiedNetworkPlayerHistoryUpdateEvent extends ProxiedDKBansNetworkPlayerEvent {

    public ProxiedNetworkPlayerHistoryUpdateEvent(UUID uuid, long timeStamp, boolean onThisServer) {
