...
public class GuiConfig extends SimpleConfig {
    ...
    public void onLoad() {
        ...
        guiData.put(BanSelfGui.class, addAndGetGuiData("ban.self", new GuiData(true, "&4Ban", new ConcurrentHashMap<String, String>(){{
            put("bantype", BanType.NETWORK.toString().toLowerCase());
            put("timeunit", TimeUnit.HOURS.toString().toLowerCase());
            put("duration", String.valueOf(-1));
        }})));
        ...
        ItemStorage.put("playerinfo_showhistory", addAndGetItemStack("playerinfo.player.items.showhistory", new ItemBuilder(ItemStackTranslator.BOOK_AND_QUILL).setDisplayName("&bShow history").setLore("&7Show the history of the player").build()));
        ...
        ItemStorage.put("globalplayerinfo_skull", addAndGetItemStack("playerinfo.global.items.skull", new ItemBuilder(ItemStackTranslator.SKULL_ITEM).setDisplayName("[player]").build()));
        //Ban
        ItemStorage.put("globalban_skull", addAndGetItemStack("ban.global.items.skull", new ItemBuilder(ItemStackTranslator.SKULL_ITEM).setDisplayName("[player]").setLore("&7Click to ban").build()));
        ...
        ItemStorage.put("selfban_chat", addAndGetItemStack("ban.self.items.chat", new ItemBuilder(ItemStackTranslator.EMPTY_MAP).setDisplayName("&4Mute").setLore("&7Click to change to ban").build()));
        ...
        ItemStorage.put("selfban_duration", addAndGetItemStack("ban.self.items.duration", new ItemBuilder(ItemStackTranslator.WATCH).setDisplayName("&cDuration").setLore("&7Current duration&8: &c[duration]").build()));
        ItemStorage.put("selfban_timeunit_seconds", addAndGetItemStack("ban.self.items.timeunit.seconds", new ItemBuilder(ItemStackTranslator.LIME_STAINED_GLASS_PANE).setDisplayName("&aSeconds").build()));
        ItemStorage.put("selfban_timeunit_minutes", addAndGetItemStack("ban.self.items.timeunit.minutes", new ItemBuilder(ItemStackTranslator.GREEN_STAINED_GLASS_PANE).setDisplayName("&2Minutes").build()));
        ItemStorage.put("selfban_timeunit_hours", addAndGetItemStack("ban.self.items.timeunit.hours", new ItemBuilder(ItemStackTranslator.YELLOW_STAINED_GLASS_PANE).setDisplayName("&eHours").build()));
        ItemStorage.put("selfban_timeunit_days", addAndGetItemStack("ban.self.items.timeunit.days", new ItemBuilder(ItemStackTranslator.RED_STAINED_GLASS_PANE).setDisplayName("&4Days").build()));
        ItemStorage.put("selfban_send", addAndGetItemStack("ban.self.items.send", new ItemBuilder(ItemStackTranslator.LIME_DYE).setDisplayName("&aSend").build()));
        ...
        ItemStorage.put("globalreport_skull", addAndGetItemStack("report.global.items.skull", new ItemBuilder(ItemStackTranslator.SKULL_ITEM).setDisplayName("[player]").setLore("&aClick to report").build()));
        ItemStorage.put("globalreport_login", addAndGetItemStack("report.global.items.login", new ItemBuilder(ItemStackTranslator.GREEN_STAINED_CLAY).setDisplayName("&aLogin").build()));
        ItemStorage.put("globalreport_logout", addAndGetItemStack("report.global.items.logout", new ItemBuilder(ItemStackTranslator.RED_STAINED_CLAY).setDisplayName("&cLogout").build()));
        ItemStorage.put("reportlist_skull", addAndGetItemStack("report.list.items.skull", new ItemBuilder(ItemStackTranslator.SKULL_ITEM).setDisplayName("[player]").setLore("&7Reason&8: [reason]", "&7Time&8: &c[time]").build()));
        ...
        ItemStorage.put("reportself_send", addAndGetItemStack("report.self.items.send", new ItemBuilder(ItemStackTranslator.LIME_DYE).setDisplayName("&aSend").build()));
        //Warn
        ItemStorage.put("globalwarn_skull", addAndGetItemStack("warn.global.items.skull", new ItemBuilder(ItemStackTranslator.SKULL_ITEM).setDisplayName("[player]").setLore("&7Click to warn").build()));
        ...
        ItemStorage.put("warnself_send", addAndGetItemStack("warn.self.items.send", new ItemBuilder(ItemStackTranslator.LIME_DYE).setDisplayName("&aSend").build()));
        //Kick
        ItemStorage.put("globalkick_skull", addAndGetItemStack("kick.global.items.skull", new ItemBuilder(ItemStackTranslator.SKULL_ITEM).setDisplayName("[player]").setLore("&7Click to kick").build()));
        ...
        ItemStorage.put("kickself_send", addAndGetItemStack("kick.self.items.send", new ItemBuilder(ItemStackTranslator.LIME_DYE).setDisplayName("&aSend").build()));
        //UnBan
        ...
        ItemStorage.put("unbanself_send", addAndGetItemStack("unban.self.items.send", new ItemBuilder(ItemStackTranslator.LIME_DYE).setDisplayName("&aSend").build()));
        ...
        ItemStorage.put("chooseunban_chat", addAndGetItemStack("unban.choosetype.items.chat", new ItemBuilder(ItemStackTranslator.EMPTY_MAP).setDisplayName("&4Chat").build()));
        //History
        ...
        ItemStorage.put("history_ban_chat", addAndGetItemStack("history.items.ban.chat", new ItemBuilder(ItemStackTranslator.EMPTY_MAP).setDisplayName("&4Mute").setLore("&7Id&8: &c[id]", "&7Reason&8: &c[reason]", "&7Time&8: &c[time]", "&7Timeout&8: &c[timeout]", "&7Message&8: &c[message]", "&7Type&8: &c[type]", "&7Staff&8: &c[staff]", "&7Ip&8: &c[ip]").build()));
        ItemStorage.put("history_unban", addAndGetItemStack("history.items.unban", new ItemBuilder(ItemStackTranslator.IRON_FENCE).setDisplayName("&4Unban").setLore("&7Id&8: &c[id]", "&7Reason&8: &c[reason]", "&7Message&8: &c[message]", "&7Type&8: &c[type]", "&7Time&8: &c[time]", "&7Staff&8: &c[staff]", "&7Ip&8: &c[ip]").build()));
    ...
    private ItemStack addAndGetItemStack(String path, ItemStack itemStack) {
        ...
        if(DKBansGuiExtension.getInstance().isConfigItemIds()) {
            if(itemStack.getType() == Material.valueOf(ItemStackTranslator.SKULL_ITEM.getMaterial())) itemBuilder = new ItemBuilder(ItemStackTranslator.SKULL_ITEM);
    ...
    private GuiData addAndGetGuiData(String path, GuiData guiData) {
        ...
        for (Map.Entry<String, String> entry : guiData.getSettings().entrySet())
            settings.put(entry.getKey(), addAndGetStringValue(path + ".settings." + entry.getKey(), entry.getValue()));
