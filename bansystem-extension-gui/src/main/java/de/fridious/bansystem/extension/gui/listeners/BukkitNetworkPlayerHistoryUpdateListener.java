...
public class BukkitNetworkPlayerHistoryUpdateListener implements Listener {

    @EventHandler
    public void onBukkitNetworkPlayerHistoryUpdate(BukkitNetworkPlayerHistoryUpdateEvent event) {
